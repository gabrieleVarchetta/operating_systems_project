...
/* Tutte e tre le seguenti procedure servono per inizializzare i vari sprite del gioco.
   Gli sprite utilizzati sono delle matrici di caratteri.
*/
void initPlayerSprite(char sprite[PLAYERSPRITE_X][PLAYERSPRITE_Y]){
    sprite[0][0] = '*';
    sprite[1][0] = '*';
    sprite[2][0] = '*';
    sprite[3][0] = '*';
...
void initEnemySprite(char sprite[ALIENSPRITE_X][ALIENSPRITE_Y]){
    sprite[0][0] = ' ';
    sprite[1][0] = '/';
    sprite[2][0] = '*';
...
void initEnemySprite2(char sprite[ALIENSPRITE_X][ALIENSPRITE_Y]){
    sprite[0][0] = 'V';
    sprite[1][0] = ' ';
    sprite[2][0] = 'V';
